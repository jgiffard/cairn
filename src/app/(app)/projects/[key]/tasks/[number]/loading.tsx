...
const Loading = () => (
  <div className="flex h-dvh animate-pulse flex-col">
    <div className="border-border flex h-[2.75rem] shrink-0 items-center gap-2 border-b px-4">
    ...
    <div className="flex min-h-0 flex-1">
      ...
      <div className="border-border hidden w-[13.75rem] shrink-0 flex-col gap-4 border-l px-4 py-5 lg:flex">
        {[0, 1, 2].map((i) => (
